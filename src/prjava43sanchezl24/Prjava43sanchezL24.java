...
public class Prjava43sanchezL24 extends Frame 
   ...
   public Prjava43sanchezL24 () { 
      ...
      setTitle("nova finestra prjava43SanchezL24");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43sanchezL24();  // Let the construct do the job 
   } 
